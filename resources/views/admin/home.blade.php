        ...
        <section id="beranda">
            <div class="lg:mt-6 space-y-12 lg:grid lg:grid-cols-2 lg:space-y-0 lg:gap-x-6">
              <div class="flex flex-col gap-5">
                <div class="bg-[#F08619] text-gray-50 text-center items-center justify-center rounded-r-full py-10" >
                ...
                <div class="flex flex-col gap-4 items-center justify-center">
                  ...
                  <a href="/admin/keloladokumen" class="bg-[#F08619] text-gray-50 text-center rounded-full w-[320px] py-4 text-lg tracking-wider gap-2 flex items-center justify-center hover:bg-[#3B6BA2] font-medium"><i class="fa-regular fa-file"></i>Kelola Dokumen</a>
