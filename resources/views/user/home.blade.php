                                ...
                                @csrf
                                    ...
                                    <div x-show="tab === 'pelapor'" x-transition>
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <input type="tel" name="phone_pelapor" id="phone_pelapor" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                        </div>
                                        <div class="flex flex-col gap-2">
                                    ...
                                    <div x-show="tab === 'korban'" x-transition>
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <input type="text" name="nama_korban" id="nama_korban" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                        </div>
                                        <div class="flex flex-col gap-2">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <input type="text" name="phone_korban" id="phone_korban" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                        </div>
                                        <div class="flex flex-col gap-2">
                                            <label class="font-semibold" for="">Status Di Kampus <span class="text-[#F08619]">*</span></label>
                                            <select type="text" name="status_korban" id="status_korban" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                    ...
                                    <div x-show="tab === 'terlapor'" x-transition>
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <label class="font-semibold" for="">No HP </label>
                                            <input type="text" name="phone_terlapor" id="phone_terlapor" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                        </div>  
                                        <div class="flex flex-col gap-2">
                                            <label class="font-semibold" for="">Status Di Kampus <span class="text-[#F08619]">*</span></label>
                                            <select type="text" name="status_terlapor" id="status_terlapor" required
                                            class="lg:w-[500px] rounded-lg bg-white px-5 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F08619]">
                                                <option value="" disabled selected>Pilih Status Di Kampus</option>
                                                <option value="Pimpinan">Pimpinan</option>
                                                <option value="Dosen">Dosen</option>
